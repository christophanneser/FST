...
namespace surf {
    ...
    public:
        ...
        bool lookupKey(const std::string &key, const position_t in_node_num, uint64_t &value) const;
    ...
    bool LoudsSparse::lookupKey(const std::string &key, const position_t in_node_num, uint64_t &value) const {
