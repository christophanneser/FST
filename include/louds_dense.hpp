...
class LoudsDense {
 ...
 public:
  ...
  bool lookupKey(const std::string &key, position_t &out_node_num, uint64_t &value) const;
...
bool LoudsDense::lookupKey(const std::string &key, position_t &out_node_num, uint64_t &value) const {
